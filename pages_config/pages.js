...
module.exports = {
  ...
  pages: {
    index: {
      ...
      description: '台灣教育改革26年，社會普遍認為愈改愈亂、學生愈改愈茫和忙，《聯合報》帶讀者進入教改時間洪流，反思過去、展望未來。如今108課綱上路，能否撕下「教改＝災難」的標籤？',
    ...
    story: {
      ...
      description: '教育改革總強調多元與鬆綁，但當機會更多，為什麼台灣教育，卻讓學生更迷惘、甚至後悔自己的選擇？一個真實故事，背後是難以翻轉的文憑迷思。新一波教改，能給孩子嘗試不同道路的勇氣嗎？',
