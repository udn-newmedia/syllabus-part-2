<template>
  <div class="all-polls">
    ...
    <p class="all-polls-intro">《聯合報》於2020年4月15日至5月4日針對1243位民眾、929所學校進行民調：</p>
...
.all-polls {
  ...
  .all-polls-remarks {
    ...
    line-height: 1.5;
    color: #999999;
    padding: 25px 22% 72px;
    @media screen and (max-width: 1024.99px) {
      padding: 25px 12.5% 72px;
    }
    @media screen and (max-width: 767.99px) {
      font-size: 15px;
      padding: 15px 3.9% 60px;
    }
    @media screen and (min-width: 768px) and (max-width: 1024.98px) {
      padding-left: 0 !important;
      padding-right: 0 !important;
